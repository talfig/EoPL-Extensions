(module environments (lib "eopl.ss" "eopl") 
  ...
  (require "store.scm")
  (require "lang.scm")
  (provide init-env empty-env extend-env apply-env apply-env->old-env)
...
;;;;;;;;;;;;;;;; initial environment ;;;;;;;;;;;;;;;;
  ...
  (define init-env 
    (lambda ()
      (extend-env 
       'i (newref (num-val 1)) (opt-null)
       (extend-env
        'v (newref (num-val 5)) (opt-null)
        (extend-env
         'x (newref (num-val 10)) (opt-null)
         (empty-env))))))
...
;;;;;;;;;;;;;;;; environment constructors and observers ;;;;;;;;;;;;;;;;
  ...
  (define apply-env
    (lambda (env search-var)
      (cases environment env
        ...
        (extend-env (bvar bval opt saved-env)
  ...
  (define apply-env->old-env
    (lambda (env search-var)
	  ...
	  (if (eqv? search-var bvar)
	    env
	    (apply-env->old-env saved-env search-var)))
        (else eopl:error 'apply-env->old-env "Unexpected env ~s" env))))
